function autocomplete(inp, div, arr) {
  ...
  inp.addEventListener("input", function(e) {
      ...
      for (i = 0; i < arr.length; i++) {
        /*check if text field value is a substring of the array value */
        if ((arr[i].toLowerCase()).includes(val.toLowerCase()) && num_divs < 5) {
          ...
          if(index == 0){
            ...
            b.innerHTML = "<h5>" + arr[i].substr(0,index) + "</h5>";
          }
          b.innerHTML += "<strong>" + arr[i].substr(index, val.length) + "</strong>";
          b.innerHTML += "<h5>" + arr[i].substr(index+val.length, arr[i].length - val.length) + "</h5>";
